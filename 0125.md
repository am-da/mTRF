...
```
<img width="627" alt="スクリーンショット 2024-01-26 6 31 40" src="https://github.com/am-da/mTRF/assets/112613519/bcf45cd6-84c2-4701-8c57-4a80f304e1bf">
...
Traceback (most recent call last):
  ...
  File "/Users/ami/anaconda3/lib/python3.10/site-packages/matplotlib/__init__.py", line 1442, in inner
    return func(ax, *map(sanitize_sequence, args), **kwargs)
  File "/Users/ami/anaconda3/lib/python3.10/site-packages/matplotlib/axes/_axes.py", line 6220, in pcolormesh
    X, Y, C, shading = self._pcolorargs('pcolormesh', *args,
  File "/Users/ami/anaconda3/lib/python3.10/site-packages/matplotlib/axes/_axes.py", line 5757, in _pcolorargs
    raise TypeError('Dimensions of C %s are incompatible with'
TypeError: Dimensions of C (32, 15) are incompatible with X (16) and/or Y (32); see help(pcolormesh)
```
</details>
