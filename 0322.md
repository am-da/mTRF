...
origin_raw = raw_brain.copy()
raw_brain.load_data()
ica.apply(raw_brain)

chs = ['Fp1', 'AF3', 'F7', 'F3', 'FC1', 'FC5', 'T7',
       'C3', 'CP1', 'CP5', 'P7', 'P3', 'Pz', 'PO3',
       'O1', 'Oz', 'O2', 'PO4', 'P4', 'P8', 'CP6',
       'CP2', 'C4', 'T8', 'FC6', 'FC2', 'F4', 'F8',
       'AF4', 'Fp2', 'Fz', 'Cz','EOG1','EOG2']

chan_idxs = [raw.ch_names.index(ch) for ch in chs]
origin_raw.plot(order=chan_idxs, start=12, duration=4)
raw_brain.plot(order=chan_idxs, start=12, duration=4)

ica.plot_overlay(eog_epochs,exclude=eog_inds,show=False)
